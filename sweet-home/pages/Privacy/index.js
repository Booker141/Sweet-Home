    ...
    return (
        <Layout>
            <>
                ...
                <h2 className={styles.secondary}>Última actualización el 4 de agosto de 2022</h2>
                ...
                <p className={styles.text}>Sweet Home es responsable del tratamiento de los datos personales de los usuarios. Por favor lea detenidamente la correspondiente política para obtener más información.</p>
                <ul className="list">
                ...
                <p className={styles.text}>Realizamos un uso sencillo con la información que nos proporciona. En general, utilizamos la información para realizar un análisis empresarial completo para evaluar y analizar las tendencias de los usuarios y así poder realizar una mejora completa de la aplicación en el futuro.
