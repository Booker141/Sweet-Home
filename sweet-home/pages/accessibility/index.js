            ...
            <Layout>
                <div className={styles.content}>
                    ...
                    <div className="content__container1">
                        ...
                        <p className={styles.text}>Hemos elegido colores con contraste para una 
                        fácil lectura e interacción ya que el uso de colores poco contrastados 
                        pueden ocasionar dolores de cabeza.</p>
                        <img src="/accessibility-1.svg" alt="Diseñadores" className={styles.img}/>
                    </div>
                    ...
                    <div className="content__container2">
                        ...
                        <img src="/accessibility2.svg" alt="Constructor de sitios" className={styles.img}/>
                    </div>
                    ...
                    <div className="content__container3">
                        ...
                        <img src="/accessibility-3.svg" alt="Página social" className={styles.img}/>
                    </div>
                    ...
                    <div className="content__container4">
                        ...
                        <img src="/accessibility-4.svg" alt="Diseño web" className={styles.img}/>
                    </div>
                    ...
                    <div className="content__container5">
                        ...
                        <img src="/accessibility-5.svg" alt="Estudiar en línea" className={styles.img}/>
                    </div>
                </div>
