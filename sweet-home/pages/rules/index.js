    ...
    return (
        <Layout>
            <>
                ...
                <p className={styles.text}>Extrema violencia: está prohibido amenazar y herir a personas a través del chat que Sweet Home proporciona o bien a través de publicaciones.
