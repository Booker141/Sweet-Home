...
/** 
  ...
  * @returns User sidebar component
  * @version 1.0
  * @description User sidebar component
*/

/**
 * This function is an user sidebar card component that receive props from page and displays them
 * in an user sidebar card
 * @param props - props received from page.
 * @returns An user sidebar card.
 */
  ...
  return (
    <>
      <a
        ...
        className={global.user__sidebar}
      >
        ...
        <div className="user__text">
          ...
          <p className={global?.sidebar__date}>
            Se unió el {calcCreated(props?.createdAt)}
          </p>
        </div>
      </a>
      <style jsx>
