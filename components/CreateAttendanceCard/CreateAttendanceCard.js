...
export default function CreateAttendanceCard (props) {
  ...
  const createAttendance = async () => {
    ...
    if(description.trim() === ''){
      ...
      toast.error('Debe escribir un mensaje para publicar', { position: "bottom-right",
        autoClose: 5000,
    ...
    if (data.error) {
      ...
      toast.success('Introduzca un cuidado', { position: "bottom-right",
        autoClose: 5000,
        hideProgressBar: true,
        closeOnClick: true,
        pauseOnHover: true,
  ...
  return (
    <>
      ...
      <div className='attendance__description'>
              ...
              <button onClick={createAttendance} className={global.buttonPrimary}>Publicar</button>
            </div>
        </div>
      <style jsx>{`
