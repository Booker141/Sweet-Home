...
/**
 * This function is a footer component for easy navigation
    ...
    <>
      <div className="content">
        <div className="waves">
          ...
          >
            <defs>
              <linearGradient id="gradient" x1="57%" y1="0%" x2="43%" y2="100%">
                <stop offset="5%" stop-color="#f9a603" />
                <stop offset="95%" stop-color="#f0810f" />
              </linearGradient>
            </defs>
            <path
              d="M 0,600 C 0,600 0,200 0,200 C 44.91771147677885,212.48382299910799 89.8354229535577,224.96764599821594 127,221 C 164.1645770464423,217.03235400178406 193.5760196625481,196.6132390062442 232,173 C 270.4239803374519,149.3867609937558 317.86049839624974,122.57939797680729 360,128 C 402.13950160375026,133.4206020231927 438.98198675245305,171.06916908652659 482,201 C 525.018013247547,230.93083091347341 574.211554593938,253.14392567708632 617,243 C 659.788445406062,232.85607432291368 696.1717948717949,190.35512820512818 732,186 C 767.8282051282051,181.64487179487182 803.1012659188826,215.43556150240087 838,202 C 872.8987340811174,188.56443849759913 907.4231414526749,127.9026257852683 949,146 C 990.5768585473251,164.0973742147317 1039.206168270417,260.9539353565261 1082,264 C 1124.793831729583,267.0460646434739 1161.752185465657,176.2816327886276 1201,142 C 1240.247814534343,107.7183672113724 1281.785089866955,129.91953348896354 1322,149 C 1362.214910133045,168.08046651103646 1401.1074550665226,184.04023325551822 1440,200 C 1440,200 1440,600 1440,600 Z"
              stroke="none"
              stroke-width="0"
              fill="url(#gradient)"
              fill-opacity="0.53"
          ...
          <div className="footer">
              ...
              <div className="columns__column1">
                ...
                <div className="column1__links">
                  <Link className={global.link} href="/about" prefetch={false}>
                    <a aria-label="Ir a información sobre Sweet Home">
                      Sobre nosotros
                    </a>
                  </Link>
                  <Link
                    ...
                    prefetch={false}
                  >
                    <a aria-label="Ir a información de contacto">Contáctanos</a>
                  </Link>
                </div>
              </div>
              <div className="columns__column2">
                ...
                <div className="column2__links">
                  <Link className={global.link} href="/faq" prefetch={false}>
                    <a aria-label="Ir a Preguntas frecuentes">
                      Preguntas frecuentes
                    </a>
                  </Link>
                  <Link className={global.link} href="/rules" prefetch={false}>
                    <a aria-label="Ir a Reglas y políticas de Sweet Home">
                      Reglas y políticas
                    </a>
                  </Link>
                </div>
              ...
              <div className="columns__column3">
                ...
                <div className="column3__links">
                  <Link
                    ...
                    prefetch={false}
                  >
                    <a aria-label="Ir a Cuidados">Cuidados</a>
                  </Link>
                  <Link className={global.link} href="/news" prefetch={false}>
                    <a aria-label="Ir a Noticias">Noticias</a>
                  </Link>
                </div>
              </div>
            </div>
            ...
            <div className="columns__column4">
              ...
              <div className="column4__icons">
                ...
                <a aria-label="Ir a Facebook" className="icons__facebook">
                  <BsFacebook />
                </a>
                <a aria-label="Ir a Twitter" className="icons__twitter">
                  <BsTwitter />
                </a>
              </div>
            </div>
