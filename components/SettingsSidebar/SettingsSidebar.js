        ...
        <>
            ...
            <aside className="settingsSidebar-layout">
                ...
                <div className="settingsSidebar-layout__container1">
                    <a className="sidebar__link" href="/profile/myprofile/settings/publicProfile" alt="Ir a editar perfil público"><HiLockOpen size={20} color={`${colors.secondary}`}/>Editar perfil público</a>
