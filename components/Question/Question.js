...
/**
 * This function is a question component that receive props from page and displays them
 * in a faq card
...
export default function Question(props) {
  ...
  const deleteQuestion = async () => {
    ...
    toast.error("Se ha eliminado la pregunta", {
          ...
          {props?.isAdmin && (
            <div className="header__buttons">
              <button
                ...
                onClick={() =>
                  Router.push(`/dashboard/editQuestion/${props?.id}`)
                }
              >
