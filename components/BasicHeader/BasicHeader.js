...
/** 
  ...
  * @returns Basic Header component
  * @version 1.0
  * @description Basic Header component
*/

/**
 * This function is a basic header component that receive props from page and displays them
 * in a basic header to help user navigate through the page
 * @param props - props received from page.
 * @returns A basic header.
 */
