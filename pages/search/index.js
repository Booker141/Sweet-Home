...
export default function Search({ results }) {
  ...
  if (session) {
    return (
      <Layout>
        <Head>
          <title>{router?.query.keyword} | Búsqueda de Sweet Home</title>
        </Head>
        ...
        <div className={global.search__card}>
          ...
          <div className="results__container">
            ...
            <div className="results__usersByEmail">
              {results.usersByEmail?.length === 0 && (
                <div className={global.loading2}>
                  No se han encontrado resultados.
                </div>
              )}
              {results.usersByEmail?.length != 0 &&
                results.usersByEmail?.map((user) => (
                  <>
                    <UserCard
                      key={user._id}
                      image={user.image}
        ...
        <div className={global.search__card}>
          ...
          <div className="results__container">
            ...
            <div className="results__postsByUser">
              {results.postsByUser?.length === 0 && (
                <div className={global.loading2}>
                  No se han encontrado resultados.
                </div>
              )}
              {results.postsByUser?.length != 0 &&
                results.postsByUser?.map((post) => (
                  <>
                    <Post
                      key={post._id}
                      id={post._id}
            ...
            <div className="results__postsByDescription">
              {results.postsByDescription?.length === 0 && (
                <div className={global.loading2}>
                  No se han encontrado resultados.
                </div>
              )}
              {results.postsByDescription?.length != 0 &&
                results.postsByDescription?.map((post) => (
                  <>
                    <Post
                      key={post._id}
                      id={post._id}
          ...
          <div className="results__container">
            ...
            <div className="results__postsByType">
              {results.typePost?.length === 0 && (
                <div className={global.loading2}>
                  No se han encontrado resultados.
                </div>
              )}
              {results.typePost?.length != 0 &&
                results.typePost?.map((post) => (
                  <>
                    <Post
                      key={post._id}
                      id={post._id}
            ...
            <div className="results__postsByLocation">
              {results.postsByLocation?.length === 0 && (
                <div className={global.loading2}>
                  No se han encontrado resultados.
                </div>
              )}
              {results.postsByLocation?.length != 0 &&
                results.postsByLocation?.map((post) => (
                  <>
                    <Post
                      key={post._id}
                      id={post._id}
        ...
        <div className={global.search__card}>
          ...
          <div className="results__container">
            ...
            <div className="results__attendancesByDescription">
              {results.attendancesByUser?.length === 0 && (
                <div className={global.loading2}>
                  No se han encontrado resultados.
                </div>
              )}
              {results.attendancesByUser?.length != 0 &&
                results.attendancesByUser?.map((attendance) => (
                  <>
                    <Attendance
                      key={attendance._id}
                      ...
                      breed={attendance.breed}
                      image={attendance.image}
                      comments={attendance.comments}
                      createdAt={attendance.createdAt}
                      username={attendance.username}
                      userId={attendance.userId}
                      threadId={attendance.threadId}
                    />
                  </>
                ))}
            </div>
            <p className={global.secondary__search}>Por descripción</p>
            <div className="results__attendancesByDescription">
              {results.attendancesByDescription?.length === 0 && (
                <div className={global.loading2}>
                  No se han encontrado resultados.
                </div>
              )}
              {results.attendancesByDescription?.length != 0 &&
                results.attendancesByDescription?.map((attendance) => (
                  <>
                    <Attendance
                      key={attendance._id}
                      location={attendance.location}
            ...
            <div className="results__attendancesByAnimal">
              {results.attendancesByAnimal?.length === 0 && (
                <div className={global.loading2}>
                  No se han encontrado resultados.
                </div>
              )}
              {results.attendancesByAnimal?.length != 0 &&
                results.attendancesByAnimal?.map((attendance) => (
                  <>
                    <Attendance
                      key={attendance._id}
                      location={attendance.location}
            ...
            <div className="results__attendancesByBreed">
              {results.attendancesByBreed?.length === 0 && (
                <div className={global.loading2}>
                  No se han encontrado resultados.
                </div>
              )}
              {results.attendancesByBreed?.length != 0 &&
                results.attendancesByBreed?.map((attendance) => (
                  <>
                    <Attendance
                      key={attendance._id}
                      location={attendance.location}
        ...
        <div className={global.search__card}>
          ...
          <div className="results__container">
            ...
            <div className="results__typeAttendanceByName">
              ...
              {results.typeAttendanceByName?.length != 0 &&
                results.typeAttendanceByName?.map((type) => (
                  <>
                    <TypeAttendance
                      key={type._id}
                      name={type.name}
            ...
            <div className="results__typeAttendancesByDescription">
              {results.typeAttendanceByDescription?.length === 0 && (
                <div className={global.loading2}>
                  No se han encontrado resultados.
                </div>
              )}
              {results.typeAttendanceByDescription?.length != 0 &&
                results.typeAttendanceByDescription?.map((type) => (
                  <>
                    <TypeAttendance
                      key={type._id}
                      name={type.name}
        ...
        <div className={global.search__card}>
          ...
          <div className="results__container">
            ...
            <div className="results__newsByTitle">
              {results.newsByTitle?.length === 0 && (
                <div className={global.loading2}>
                  No se han encontrado resultados.
                </div>
              )}
              {results.newsByTitle?.length != 0 &&
                results.newsByTitle?.map((news) => (
                  <>
            ...
            <div className="results__newsByAuthor">
              {results.newsByAuthor?.length === 0 && (
                <div className={global.loading2}>
                  No se han encontrado resultados.
                </div>
              )}
              {results.newsByAuthor?.length != 0 &&
                results.newsByAuthor?.map((news) => (
                  <>
                    <div className="new__container">
                      <New
                        key={news._id}
