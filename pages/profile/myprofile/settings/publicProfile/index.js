 ...
 * @returns Public information page
 * @version 1.0
 * @description Public information page
 */
export default function PublicProfile({ users }) {
  ...
  const deleteAccount = async (e) => {
    ...
    toast.error(`Se ha eliminado la cuenta correctamente`, {
  ...
  const edit = async (e) => {
    ...
    if (isValidate) {
      ...
      toast.error(`Introduzca los datos correctamente`, {
        position: "bottom-right",
        autoClose: 5000,
        hideProgressBar: true,
        closeOnClick: true,
  ...
  if (session) {
    return (
      <SettingsLayout>
        <Head>
          <title>Editar perfil público | Sweet Home</title>
        </Head>
        <div className="settings">
          <div className="form-page">
            <h1 className={global.title}>Editar perfil público </h1>
            <p className={global.text}>
              Los usuarios que visiten tu perfil público podrán ver la siguiente
              información:
            </p>
            <form
              ...
              <div className="form-vertical__location">
                ...
                <div className="location__input">
                  <input
                    ...
                    className="input"
                  />
                  <div id="success__location" className="form__success-icon">
                    <BsFillCheckCircleFill
                      size={20}
                      color={statusColors.success}
                    />
            ...
            <div className="action__buttons">
              ...
              />
              <button
                className={global.buttonDelete2}
        ...
        {isModalVisible && (
          <Modal>
            ...
            <p className={global.text2}>
              Eliminando la cuenta, será eliminados todos sus datos de la
              aplicación
            </p>
