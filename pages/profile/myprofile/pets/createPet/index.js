 ...
 * @returns Create pet page
 * @version 1.0
 * @description Create pet page
 */
export default function CreatePet() {
  ...
  const createPet = async (e) => {
    ...
    if (data.error) {
      ...
      toast.success(`La mascota ha sido creada correctamente`, {
        position: "bottom-right",
        autoClose: 5000,
        hideProgressBar: true,
        closeOnClick: true,
  ...
  if (session) {
    return (
      <Layout>
        <Head>
          <title>Crear mascota | Sweet Home</title>
        </Head>
