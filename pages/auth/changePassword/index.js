  ...
  const validate = (e) => {
    ...
    if (e.target.name == 'oldPassword') {
      if (oldPassword.length < 8 || !oldPassword.match(regPassword)) {
        ...
        document.getElementById('success__oldPassword').classList.remove('form__success-icon--active')
        setIsValidate(false)
      } else {
        document.getElementById('oldPassword__error').classList.remove('form__input-passwordError--active')
        document.getElementById('success__oldPassword').classList.add('form__success-icon--active')
        setIsValidate(true)
      }
    }
  ...
  const changePassword = async (e) => {
    ...
    if(isValidate){
        ...
        if (data.message === 'Se ha cambiado la contraseña correctamente.') {
            ...
            toast.success(`Se ha cambiado la contraseña correctamente`, { position: "bottom-right",
            autoClose: 5000,
          ...
          if (data.message === 'Contraseña actual incorrecta.') {
            ...
            toast.error(`La contraseña actual incorrecta.`, { position: "bottom-right",
            autoClose: 5000,
            hideProgressBar: true,
            closeOnClick: true,
            pauseOnHover: true,
          ...
          if (data.message === 'La nueva contraseña no puede ser igual a la actual.') {
            ...
            toast.error(`La nueva contraseña no puede ser igual a la actual.`, { position: "bottom-right",
            autoClose: 5000,
            hideProgressBar: true,
            closeOnClick: true,
            pauseOnHover: true,
        ...
        <>
          ...
          <div className={global.content}>
            <div className='form'>
              ...
              <input className={global.buttonPrimary} type='submit' onClick={(e) => changePassword(e)} value={isChanging ? 'Cambiando..' : 'Cambiar'} />
            </div>
          </div>
          <style jsx>{`
