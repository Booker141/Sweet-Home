...
export default function SignIn({ providers, csrfToken, account }) {
  ...
  const Login = async (e) => {
    ...
    document
      .getElementById("submit__error")
      .classList.remove("submit__error--active");
      ...
      <div className={global.content}>
        <div className="page">
          <div className="page__form">
              ...
              Object.values(providers)
                ...
                .map((provider) => (
                  <div key={provider?.name}>
                    <button
                      className="form-vertical__button2"
                      onClick={() =>
              ...
              <div className="form-vertical__password">
                ...
                {account?.provider != "google" &&
                  account?.provider != "twitter" && (
                    <Link href={`${server}/auth/resetPassword`}>
                      <a aria-label="Ir al formulario de cambio de contraseña">
            ...
            <input
              type="submit"
              value={isSignIn ? "Iniciando sesión.." : "Iniciar sesión"}
              className="form-vertical__button"
              onClick={(e) => Login(e)}
            />
            <div className="form-register">
              <h6>¿No tiene una cuenta?</h6>
              <Link href={`${server}/auth/signUp`}>
                <a aria-label="Ir al formulario de registro">
                  ¡Regístrate aquí!
                </a>
              </Link>
            </div>
