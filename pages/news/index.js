...
export default function News({ news, users }) {
  ...
  return (
    <BasicLayout>
      <Head>
        <title>Noticias | Sweet Home</title>
      </Head>
      ...
      <section>
        <div className="news__header">
          ...
          <p className={global.text}>
            ¡En este apartado podrá encontrar las últimas noticias relacionadas
        ...
        {news?.length === 0 && (
          <div>
            <p className={global.loading2}>No hay ninguna noticia publicada.</p>
          </div>
        )}
        ...
        <div className="news__list">
          {news
            ?.sort((new1, new2) => {
              return new Date(new2.date) - new Date(new1.date);
            })
            .map(({ _id, title, date, author, introduction }) => {
              return (
                <>
                  <div className="new">
                    <New
                    ...
                    <Link
                      ...
                      prefetch={false}
                    >
                      <a aria-label="Enlace a noticia" className={global.link3}>
                        Leer más →
                      </a>
                    </Link>
                  </div>
