...
export default function Privacy () {
  return (
    <BasicLayout>
      ...
      <hr className={global.line} />
      <h6 className={global.text}>La recopilación de información
        ...
        hace uso de la aplicación en:
      </h6>
      <ul className={global.list}>
        <li className={global.list__item}> Nombre, correo electrónico, teléfono, fecha de cumpleaños,
          género y otros datos que proporciona en el formulario de registro.
        </li>
      ...
      <hr className={global.line} />
      <h6 className={global.text}>Realizamos un uso sencillo con la
      ...
      <h2 className={global.secondary}>3. Información sobre la privacidad de los niños</h2>
      <hr className={global.line} />
      <p className={global.text}>Sabemos la importancia de proteger la
        ...
        que realizan sus hijos en nuestros servicios en línea.
      </p>

      <h2 className={global.secondary}>4. Enlace a redes sociales</h2>
      <hr className={global.line} />
      <p className={global.text}>En nuestra aplicación hacemos uso de enlaces
        ...
        de privacidad y condiciones de dichos sitios.
      </p>

      <h2 className={global.secondary}>5. Seguridad de la información</h2>
      <hr className={global.line} />
      <p className={global.text}>Tomaremos todas las medidas necesarias y adecuadas
        ...
        la información contra la pérdida, acceso, uso ilegal o divulgación.
      </p>

      <h2 className={global.secondary}>6. Conservación</h2>
      <hr className={global.line} />
      <p className={global.text}>Conservaremos la información durante el tiempo
        ...
        nos encargaremos de hacerlo inmediatamente.
      </p>

      <h2 className={global.secondary}>7. Cambios en la política de privacidad</h2>
      <hr className={global.line} />
      <p className={global.text}>Esta política de privacidad es posible que sufra
