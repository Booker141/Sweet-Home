...
/** 
  ...
  * @returns Create complaint page
  * @version 1.0
  * @description Create complaint page
*/
export default function CreateComplaint({ users }) {
  ...
  const createComplaint = async (e) => {
    ...
    if (data.error) {
      ...
      router.push("/profile/myprofile/complaints");
    }
  };
  ...
  if (session) {
    return (
      <Layout>
        <Head>
          <title>Crear denuncia | Sweet Home</title>
        </Head>
        <div className="container__form">
          <div className="form">
            <div className="container__header">
              <h1 className="title">Creación de denuncia</h1>
              <h3 className={global.text2__bold}>
                De parte de @{session.user.username}
              </h3>
              <p className={global.text2}>
                Introduzca los datos de la denuncia. Los campos obligatorios
                vienen indicados con un asterisco *:
              </p>
            </div>
            <form action="/api/complaints" id="form">
              <div className="form-vertical__user">
                <label className="label">
                  <p className={global.text}>
                    Elige el usuario al que quiere interponer una denuncia:
                  </p>
                </label>
                <select
                  name="user"
              ...
              <div className="form-vertical__reasonList">
                ...
                <select
                  ...
                  required
                >
                  <option default value="Spam">
                    Spam
                  </option>
                  <option value="Contenido inapropiado">
                    Contenido inapropiado
                  </option>
                  <option value="Finge ser otra persona">
                    Finge ser otra persona
                  </option>
                  <option value="Datos de perfil inapropiados">
                    Datos de perfil inapropiados
                  </option>
                  <option value="Infracción de normas y reglas de Sweet Home">
                    Infracción de normas y reglas de Sweet Home
                  </option>
