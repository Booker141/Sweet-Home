            ...
            <div className='container__header'>
              ...
              <div className='form-vertical__user'>
                <label className="label">
                  <p className={global.text}>Elige el usuario al que quiere interponer una denuncia:</p>
                </label>
                  <select name="user" onChange={(e) => setUser(e.target.value)} required>
                    {users.length === 0 && <option default value="zero">No existe ningún usuario</option>}
                    {users.map((user) => {
                        return(
                            <>
