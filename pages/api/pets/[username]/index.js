...
export default async function handler (req, res) {
  ...
  if (req.method == 'POST') {
    ...
    await db.collection('pets').insertOne({_id: petId, animal: body.animal, breed: body.breed, name: body.name, weight: parseFloat(body.weight), image: body.image, ownerId: ObjectId(body.userId), ownerUsername: body.username, birthdate: new Date(body.birthdate)})
