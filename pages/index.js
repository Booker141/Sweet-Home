      ...
      <div className={global.content}>
        ...
        <div className="content__container2">
          <div className="container2__column1">
            ...
            <p className="subtext">
              La mayor comunidad de amantes de los animales 🐾
            </p>
          </div>
        ...
        <div className="content__container3">
          ...
          <p className={global.text}>
            Es una red social que abarca el mundo animal y trata de facilitar su
            adaptación a nuevos cuidados, a nuevos dueños y a una mejora diaria
            de su vida.
          </p>
          <Link href="/about" prefetch={false}>
            <a
              className={global.link}
              aria-label="Ir a información sobre Sweet Home"
            >
              Saber más →
            </a>
          </Link>
        ...
        <div className="content__container4">
          <div className="container4__column1">
            ...
            <p className={global.text4}>
              Nuestra red social se diferencia de otras redes sociales en las
          ...
          <div className={global.cards}>
            <div className={global.card__short}>
              ...
              <p className={global.text4}>
                En nuestra red social podrás encontrar cuidados que mejoren la
                calidad de vida de tu mascota.
              </p>
              <Link href="/attendances" prefetch={false}>
                <a className={global.link} aria-label="Ir a Cuidados">
                  Acceder →
                </a>
              </Link>
            </div>
            <div className={global.card__short}>
              ...
              <p className={global.text4}>
                Aquí encontrarás una comunidad de amantes de los animales que
                pueden darte consejos sobre vuestras mascotas.
              </p>
              <Link href="/home" prefetch={false}>
                <a
                  className={global.link}
                  aria-label="Ir a página inicial de Sweet Home"
                >
                  Acceder →
                </a>
              </Link>
            ...
            <div className={global.card__short}>
              ...
              <p className={global.text4}>
                ¡Existen perfiles exclusivos de protectoras si quieres encontrar
                tu mascota ideal!
              </p>
              <Link href="/allShelters" prefetch={false}>
                <a className={global.link} aria-label="Ir a cuidadoras">
                  Acceder →
                </a>
              </Link>
            </div>
      ...
      <div className="content__container6">
          ...
          <div className="column1__text">
            ...
            <div className="text">
              <p className={global.text}>
                ...
                perdidos? ¿No puedes cuidar de tu mascota o has encontrado a una
                que se ha perdido y no sabes que hacer? Con Sweet Home daremos
                respuesta a estas preguntas.
              </p>
              <p className={global.text}>
                El objetivo principal de Sweet Home es facilitándole a los
                dueños funcionalidades que usar en su día a día. Entre ellas
                están: publicar fotos e información de los animales, permitir el
                contacto inmediato con el usuario que ha realizado una
                publicación y seguir a los centros de acogida de animales que
                sean de interés.
              </p>
            </div>
          </div>
        ...
        <div className="container6__column2">
          ...
          <div className="column2__text">
            ...
            <div className="text">
              <p className={global.text}>
                Para llevar a cabo nuestra misión, hemos creado una red social
                que permite a los usuarios compartir información sobre sus
                mascotas, así como también, información sobre animales perdidos
                o encontrados. Además, los usuarios podrán seguir a los centros
                de acogida de animales que sean de su interés.
              </p>
              <p className={global.text}>
                Además, los usuarios podrán publicar fotos e información de los
                animales, permitir el contacto inmediato con el usuario que ha
                realizado una publicación y seguir a los centros de acogida de
                animales que sean de interés.
              </p>
            </div>
          </div>
        </div>
