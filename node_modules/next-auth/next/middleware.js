...
async function handleMiddleware(req, options = {}, onSuccess) {
  ...
  const host = (0, _web.detectHost)(options.trustHost, (_req$headers = req.headers) === null || _req$headers === void 0 ? void 0 : _req$headers.get("x-forwarded-host"), (_process$env$NEXTAUTH2 = process.env.NEXTAUTH_URL) !== null && _process$env$NEXTAUTH2 !== void 0 ? _process$env$NEXTAUTH2 : process.env.NODE_ENV !== "production" && "http://localhost:3000");
