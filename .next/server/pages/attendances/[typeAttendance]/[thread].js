...
function Thread({ attendances  }) {
    const { data: session , status  } = (0,next_auth_react__WEBPACK_IMPORTED_MODULE_4__.useSession)({
        required: true
    });
    const { 0: isSortedByUsername , 1: setIsSortedByUsername  } = (0,react__WEBPACK_IMPORTED_MODULE_5__.useState)(false);
    const { 0: isSortedByDate , 1: setIsSortedByDate  } = (0,react__WEBPACK_IMPORTED_MODULE_5__.useState)(false);
    const { 0: sortedAttendances , 1: setSortedAttendances  } = (0,react__WEBPACK_IMPORTED_MODULE_5__.useState)(attendances);
        ...
        return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components_Layout_Layout__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z, {
            children: [
                ...
                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("h1", {
                    className: (_styles_global_module_css__WEBPACK_IMPORTED_MODULE_7___default().title),
                    children: router.query.thread
                }),
                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                    className: "sort__buttons",
                    children: [
                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("button", {
                            className: (_styles_global_module_css__WEBPACK_IMPORTED_MODULE_7___default().buttonPrimary),
                            onClick: ()=>Router.push(`/attendances/${router.query.thread}/createAttendance`),
                            "aria-label": "Crear nuevo cuidado",
                            children: "Crear nuevo cuidado"
                        }),
                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("button", {
                            className: (_styles_global_module_css__WEBPACK_IMPORTED_MODULE_7___default().buttonPrimary),
                            onClick: ()=>sortThreadByUsername(),
                            "aria-label": "Ordenar categor\xedas por usuario",
                ...
                attendances.length === 0 && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                    children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("p", {
                        className: (_styles_global_module_css__WEBPACK_IMPORTED_MODULE_7___default().loading),
                        children: "Cargando.."
                    })
                ...
                isSortedByUsername && sortedAttendances.map(({ _id , name , typeAttendanceId , createdAt , userId  })=>{
                    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
                        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(Attendance, {
                            name: name,
...
async function getServerSideProps(context) {
    ...
    const res = await fetch(`http://localhost:3000/api/attendances/${thread}`, {
        method: "GET",
        headers: {
...
var __webpack_exports__ = __webpack_require__.X(0, [676,3061,8841,9493], () => (__webpack_exec__(9177)));
